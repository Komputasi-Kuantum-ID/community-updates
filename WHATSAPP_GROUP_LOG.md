...
* Harapan anggota adalah mencari *insight* dan teman belajar, serta menjadi pionir yang mempopulerkan kuantum di Indonesia agar tidak menjadi 'konsumen' melainkan dapat menjadi 'produsen'.

## 💼 *Opportunity* (Peluang)
Berikut adalah peluang dan kesempatan yang dibagikan atau dibahas di grup:
...
* Informasi mengenai **SQA PhD Scholarships** dan **Future Leaders in Quantum Computing Scholarship** dari **Sydney Quantum Academy (SQA)** yang dibuka tiap tahun dalam dua gelombang.
    * Link: `https://sydneyquantum.org/program/sqa-phd-scholarships/` dan `https://sydneyquantum.org/program/future-leaders-in-quantum-computing-scholarship/`

## 🤝 Komunitas *Quantum Computing* Lain
Informasi mengenai komunitas dan sumber daya lain di bidang kuantum yang dibagikan oleh anggota:
...
| **Indonesian Quantum Initiative (IQI)** | Komunitas | WAG terpisah: `https://iqi.cat` | - |
| **Grup Telegram** | Grup Komputasi Kuantum Indonesia | `t.me/idqce` | - |
